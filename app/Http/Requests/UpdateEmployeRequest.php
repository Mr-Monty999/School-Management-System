...
class UpdateEmployeRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            "employe_phone" => "required|unique:employees,employe_phone," . $this->id,
            "employe_job" => "required",
            'employe_national_number' => 'required|numeric|digits:12|unique:employees,employe_national_number,' . $this->id
        ];
    }
