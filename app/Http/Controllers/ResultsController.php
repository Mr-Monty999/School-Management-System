...
class ResultsController extends Controller
{
    ...
    {
        //$students = Student::with('results')->where('class_id',$result->id)->get();
        $result->load('students','students.results','students.results.subject');
        //dd($result);
    ...
    {
        $student->load('results','results.subject','results.teacher:id,teacher_name');
        //dd($student);
